...
extension StockInfo {
    ...
    static func getStockDataAsMatrix() -> [[StockInfo]] {
        ...
        let uniqueSections = Set(stockDataDateToString)//get rid of duplicates
        
        //what ever amount is there it will make 8 spaces in the arra/.count of item/ box for each, in one array, it makes it an array of arrays
